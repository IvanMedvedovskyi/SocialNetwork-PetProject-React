...
import {UsersType} from "../../assets/redux/users-reducer";
...
type UsersPropsType = {
    ...
    addNewCurrentPage: () => void
    unfollowUser: () => void
    followUser: () => void
    loading: boolean
}

const Users: React.FC<UsersPropsType> = ({usersList,currentPage,countOfPages,
                handleInputChange,addNewCurrentPage,unfollowUser,
                followUser,loading}) => {
    return (
        loading && !usersList ?
            <Preloader/> :
